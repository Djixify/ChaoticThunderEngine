...
std::vector<load_shader> load_shader::LoadProgramFolder(std::filesystem::path path) {
...
std::vector<std::pair<std::string, std::vector<load_shader>>> load_shader::LoadProgramSubfolders(std::filesystem::path path) {
